...
# Per-translation-unit derivations
  config_test_build_MinSizeRel_config_test_cpp_o = cmakeNixCC {
    name = "config_test.o";
    src = ./..;
    buildInputs = [ gcc ];
    source = "build-MinSizeRel/config_test.cpp";
    compiler = gcc;
    flags = "-Os -DNDEBUG -std=gnu++17 -DCMAKE_BUILD_TYPE_MINSIZEREL -std=c++17";
  };

  opt_lib_build_MinSizeRel_config_test_cpp_o = cmakeNixCC {
    name = "config_test.o";
    src = ./..;
    buildInputs = [ gcc ];
    source = "build-MinSizeRel/config_test.cpp";
    compiler = gcc;
    flags = "-Os -DNDEBUG -std=gnu++17 -std=c++17";
  };
  ...
  link_config_test = cmakeNixLD {
    ...
    type = "executable";
    buildInputs = [ gcc ];
    objects = [ config_test_build_MinSizeRel_config_test_cpp_o ];
    compiler = gcc;
    compilerCommand = "g++";
  };
  ...
  link_opt_lib = cmakeNixLD {
    ...
    type = "static";
    buildInputs = [ gcc ];
    objects = [ opt_lib_build_MinSizeRel_config_test_cpp_o ];
    compiler = gcc;
    compilerCommand = "g++";
  };
  ...
  link_config_test_install = stdenv.mkDerivation {
    ...
    dontConfigure = true;
    installPhase = ''
      mkdir -p $out/bin/MinSizeRel
      cp $src $out/bin/MinSizeRel/config_test
    '';
  };
  ...
  link_opt_lib_install = stdenv.mkDerivation {
    ...
    dontConfigure = true;
    installPhase = ''
      mkdir -p $out/lib/MinSizeRel
      cp $src $out/lib/MinSizeRel/libopt_lib.a
    '';
  };
