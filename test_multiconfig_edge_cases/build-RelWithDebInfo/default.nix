...
# Per-translation-unit derivations
  config_test_build_RelWithDebInfo_config_test_cpp_o = cmakeNixCC {
    name = "config_test.o";
    src = ./..;
    buildInputs = [ gcc ];
    source = "build-RelWithDebInfo/config_test.cpp";
    compiler = gcc;
    flags = "-O2 -g -DNDEBUG -std=gnu++17 -DCMAKE_BUILD_TYPE_RELWITHDEBINFO -std=c++17";
  };

  opt_lib_build_RelWithDebInfo_config_test_cpp_o = cmakeNixCC {
    name = "config_test.o";
    src = ./..;
    buildInputs = [ gcc ];
    source = "build-RelWithDebInfo/config_test.cpp";
  ...
  link_config_test = cmakeNixLD {
    ...
    type = "executable";
    buildInputs = [ gcc ];
    objects = [ config_test_build_RelWithDebInfo_config_test_cpp_o ];
    compiler = gcc;
    compilerCommand = "g++";
  };
  ...
  link_opt_lib = cmakeNixLD {
    ...
    type = "static";
    buildInputs = [ gcc ];
    objects = [ opt_lib_build_RelWithDebInfo_config_test_cpp_o ];
    compiler = gcc;
    compilerCommand = "g++";
  };
