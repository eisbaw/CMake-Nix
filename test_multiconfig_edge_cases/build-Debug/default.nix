...
# Per-translation-unit derivations
  config_test_build_Debug_config_test_cpp_o = cmakeNixCC {
    name = "config_test.o";
    src = ./..;
    buildInputs = [ gcc ];
    source = "build-Debug/config_test.cpp";
    compiler = gcc;
    flags = "-g -std=gnu++17 -std=c++17";
  };

  opt_lib_build_Debug_config_test_cpp_o = cmakeNixCC {
    name = "config_test.o";
    src = ./..;
    buildInputs = [ gcc ];
    source = "build-Debug/config_test.cpp";
  ...
  link_config_test = cmakeNixLD {
    ...
    type = "executable";
    buildInputs = [ gcc ];
    objects = [ config_test_build_Debug_config_test_cpp_o ];
    compiler = gcc;
    compilerCommand = "g++";
  };
  ...
  link_opt_lib = cmakeNixLD {
    ...
    type = "static";
    buildInputs = [ gcc ];
    objects = [ opt_lib_build_Debug_config_test_cpp_o ];
    compiler = gcc;
    compilerCommand = "g++";
  };
  ...
  link_config_test_install = stdenv.mkDerivation {
    ...
    installPhase = ''
      ...
      cp $src $out/bin/Debug/config_test
    '';
  };
  ...
  link_opt_lib_install = stdenv.mkDerivation {
    ...
    installPhase = ''
      ...
      cp $src $out/lib/Debug/libopt_lib.a
    '';
  };
